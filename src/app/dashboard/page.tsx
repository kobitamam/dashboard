      ...
      <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card className="p-5 lg:col-span-2">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link href="/dashboard/cases" className="text-sm font-medium text-brand-blue hover:underline">
              כל התיקים ←
            </Link>
          </div>
        ...
        <Card className="p-5">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link href="/dashboard/alerts" className="text-sm font-medium text-brand-blue hover:underline">
              הכל ←
            </Link>
          </div>
          <div className="space-y-3">
